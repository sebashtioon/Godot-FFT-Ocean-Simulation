...
/**
* samples the ocean displacement maps at arbitrary world pos
* output is vec4(height, normal.x, normal.y, normal.z) per query

i am porfessional graphics porgrammer
*/
...
void main() {
   ...
   for (uint i = 0U; i < cascades; ++i) {
       ...
       // Central differences in UV space, converted to world-space slopes.
